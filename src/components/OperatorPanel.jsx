    ...
    <div className="operator-panel_sections">
      ...
      <div className="operator-web-section">
            ...
            <div className="__description">
                <h3>Aktiv təcrübəçilərin işlə təmin olunmaq imkanı</h3>
            </div>

            <div className="__image">
                <img src="https://res.cloudinary.com/dn2b3gtui/image/upload/v1684948318/image_2023-05-24_211156208_b8b3hi.png" alt="operator panel" />
            </div>
      ...
      <div className="operator-mobil-section">
            ...
            <div className="__description">
                <h3>Təcrübə Mərkəzinin təşkil etdiyi təcrübə proqramı ərzində rəsmi diplom əldə etmək imkanı</h3>
