    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        ...
        <InputControl
          label="Başlıq"
          value={values.title}
          placeholder="İş başlığı daxil et"
          onChange={(event) =>
      ...
      <div className={styles.row}>
        <InputControl
          ...
          placeholder="Vebsayt linki daxil et"
          onChange={(event) =>
        ...
        <InputControl
          ...
          placeholder="Linkedin linki daxil et"
          onChange={(event) =>
      ...
      <div className={styles.row}>
        ...
        <InputControl
          ...
          type="tel"
          value={values.phone}
          placeholder="Tel.nömrəsi daxil et"
          onChange={(event) =>
    ...
    <div className={styles.detail}>
      ...
      <div className={styles.row}>
        <InputControl
          ...
          placeholder="Sertifikat linki daxil et"
      ...
      <div className={styles.column}>
        <label>İş təsvirini daxil et</label>
        <InputControl
          placeholder="1"
    ...
    <div className={styles.detail}>
      <div className={styles.row}>
        <InputControl
          label="Başlıq"
          value={values.title}
          placeholder="Bakalavr(Magistr)/ixtisas adı daxil et"
          onChange={(event) =>
            setValues((prev) => ({ ...prev, title: event.target.value }))
          }
        />
      ...
      <InputControl
        label="Kollec/Universitet "
        value={values.college}
        placeholder="Kollec/Universitet adı daxil et"
        onChange={(event) =>
      ...
      <div className={styles.row}>
        <InputControl
          label="Başlama tarixi"
          type="date"
          placeholder="Təhsilə başladığınız tarixi daxil et"
          value={values.startDate}
          onChange={(event) =>
            setValues((prev) => ({ ...prev, startDate: event.target.value }))
          }
        />
        <InputControl
          label="Bitirmə tarixi"
          type="date"
          placeholder="Təhsili bitirdiyiniz tarixi daxil et"
          value={values.endDate}
          onChange={(event) =>
            setValues((prev) => ({ ...prev, endDate: event.target.value }))
          }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.body}>
        ...
        <button onClick={handleSubmission}>Yadda saxla</button>
      </div>
    </div>
  );
}
